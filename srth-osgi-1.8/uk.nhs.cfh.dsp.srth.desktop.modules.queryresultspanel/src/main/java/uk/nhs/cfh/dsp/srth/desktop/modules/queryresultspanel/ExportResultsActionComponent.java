...
import uk.nhs.cfh.dsp.srth.desktop.modules.queryresultspanel.actions.ExportResultsAction;
 ...
 */
public class ExportResultsActionComponent extends AbstractActionComponent{
    ...
    /** The logger. */
    private static Log logger = LogFactory.getLog(ExportResultsActionComponent.class);
     ...
     */
    public ExportResultsActionComponent(ApplicationService applicationService,
     ...
     */
    public ExportResultsActionComponent() {
        super("Query", 0, 4, true);
    }
