...
import uk.nhs.cfh.dsp.srth.desktop.actions.querycrud.core.actions.SaveQueryToFileAction;
 ...
 * {@link uk.nhs.cfh.dsp.srth.desktop.actions.querycrud.core.actions.SaveQueryToFileAction}
 * 
 * <br>Version : @#VersionNumber#@
 * <br>Written by @author jay
 * <br>Created on Nov 28, 2009 at 2:06:22 PM
 */
public class SaveQueryToFileActionComponent extends AbstractActionComponent{
    ...
    /** The logger. */
    private static Log logger = LogFactory.getLog(SaveQueryToFileActionComponent.class);



    /**
     * Instantiates a new save query to file action component.
     * 
     ...
     */
    public SaveQueryToFileActionComponent(ApplicationService applicationService,
     ...
     */
    public SaveQueryToFileActionComponent() {
        super("File", 3, 3, true);
    }
    ...
    public synchronized void init(){
        ...
        setAction(new SaveQueryToFileAction(applicationService, queryService, queryExpressionFileOutputter));
