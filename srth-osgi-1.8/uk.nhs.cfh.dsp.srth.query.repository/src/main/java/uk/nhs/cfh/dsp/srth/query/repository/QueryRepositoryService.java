...
/**
 * An interface specification for a repository service that manages.
 *
 * {@link uk.nhs.cfh.dsp.srth.query.model.om.QueryExpression}s
 * 
 * <br>Version : @#VersionNumber#@
 * <br>Written by @author jay
 * <br>Created on Nov 30, 2009 at 9:12:01 PM
 */
public interface QueryRepositoryService {
     ...
     * @return the list
     */
    List<QueryExpression> findUsingSearchTerm(String searchTerm);
